...
もともと LiveScript という名前だったけど，あるとき Java の制御構文とか使えるようにすることがあって，そのときに Java という名前がつけられた。
...
ループに対してラベルをつけることができる。こうすることで，入れ子になったループでどのループを `break` するか決めることができる。
